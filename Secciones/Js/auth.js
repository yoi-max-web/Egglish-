...
export async function logoutUser() {
  ...
  // 🩹 Borra el consejo del día guardado en esta sesión, para que al
  // volver a iniciar sesión se elija uno nuevo al azar (ver perfil.html).
  try { sessionStorage.removeItem('egglish_tip_index'); } catch {}
